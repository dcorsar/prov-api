...
public class ProvO {
	...
	public static final String used = ns+"used";
	...
	public static final String wasDerivedFrom = ns+"wasDerivedFrom";
	public static final String wasGeneratedBy = ns+"wasGeneratedBy";
	public static final String wasInformedBy = ns+"wasInformedBy";
